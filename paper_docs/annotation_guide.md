...
- Spot-checked 100 random images per dataset
- Verified bbox covers the subject adequately
- Flagged images where detection clearly failed
- Re-annotated flagged images manually if needed
...
| CVAT  | Manual annotation refinement |
